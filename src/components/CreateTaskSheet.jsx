...
export default function CreateTaskSheet({ isOpen, onClose, onSubmit, tags, currentUser, onCreateTag, parentTask }) {
  ...
  useEffect(() => {
    if (isOpen) setForm({ ...INITIAL, tag_id: parentTask?.tag_id || '', assigned_to: currentUser || '' });
  }, [isOpen, parentTask, currentUser]);
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
          <h2 style={{ fontFamily: "'Lora', serif", fontSize: 22, fontWeight: 700, color: '#2C3E2D' }}>
            {parentTask ? 'Follow-up erstellen' : 'Neue Aufgabe'}
          </h2>
