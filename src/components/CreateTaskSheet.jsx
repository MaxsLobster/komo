...
export default function CreateTaskSheet({ isOpen, onClose, onSubmit, onSave, tags, currentUser, onCreateTag, parentTask, editTask }) {
      ...
      >
        ...
        {parentTask && !isEdit && (
          <p style={{ fontSize: 13, color: '#7D917E', marginBottom: 16 }}>
            Follow-up zu: <span style={{ fontWeight: 600, color: '#2C3E2D' }}>{parentTask.title}</span>
          </p>
        )}
